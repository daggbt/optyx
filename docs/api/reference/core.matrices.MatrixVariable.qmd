...
| [size](#optyx.core.matrices.MatrixVariable.size) | Return the total number of elements. |
...
| [diagonal](#optyx.core.matrices.MatrixVariable.diagonal) | Return the diagonal of the matrix. |
| [eq](#optyx.core.matrices.MatrixVariable.eq) | Element-wise == constraint. |
...
| [sum](#optyx.core.matrices.MatrixVariable.sum) | Sum all elements of this matrix. |
...
```python
core.matrices.MatrixVariable.diagonal(offset=0)
```
...
| Name   | Type         | Description                                                                                               | Default   |
|--------|--------------|-----------------------------------------------------------------------------------------------------------|-----------|
| offset | [int](`int`) | Diagonal offset from the main diagonal.     Positive means above main diagonal,     negative means below. | `0`       |
...
### eq { #optyx.core.matrices.MatrixVariable.eq }

```python
core.matrices.MatrixVariable.eq(other)
```
...
### sum { #optyx.core.matrices.MatrixVariable.sum }

```python
core.matrices.MatrixVariable.sum()
```
...
| Name   | Type                                         | Description                                                         |
|--------|----------------------------------------------|---------------------------------------------------------------------|
|        | [MatrixSum](`optyx.core.matrices.MatrixSum`) | MatrixSum expression (scalar) representing the sum of all elements. |
