...
| **NLP** | n=50 | 4.9x | 2.9x | Gradient compilation overhead |
| **NLP** | n=500 | 15.8x | 8.5x | Autodiff overhead at medium scale |
| **NLP** | n=5000 | 68.4x | 36.1x | Simple quadratic; SciPy converges instantly |
| **CQP** | n=50 | 2.3x | 2.0x | O(1) Jacobian compilation |
| **CQP** | n=500 | 1.6x | 1.1x | Near-parity with SciPy |
| **CQP** | n=5000 | 1.0x | 1.0x | Perfect scaling |
| **MILP** | n=50 | 1.4x | 1.1x | Near-parity with SciPy milp |
| **MILP** | n=500 | 9.4x | 1.1x | Warm solves at parity |
| **MILP** | n=5000 | 1.0x | 1.0x | Perfect scaling |
...
|---|-------|------------|------------|-------|---------------|---------------|
| 10 | 0.3ms | 5.2ms | 1.2ms | 1.1ms | 5.2x | 1.1x |
| 25 | 0.7ms | 7.1ms | 1.3ms | 1.2ms | 6.5x | 1.1x |
| 50 | 3.1ms | 24.5ms | 1.8ms | 1.7ms | 16.3x | 1.1x |
| 100 | 9.0ms | 114.1ms | 3.3ms | 3.0ms | 41.1x | 1.1x |
| 200 | 59.7ms | 416.5ms | 9.0ms | 8.4ms | 56.6x | 1.1x |
| 500 | 515.1ms | 3,683.9ms | 54.3ms | 53.7ms | 78.1x | 1.0x |
...
| n | Build | Cold Solve | Warm Solve | SciPy | Cold Overhead | Warm Overhead |
|---|-------|------------|------------|-------|---------------|---------------|
| 10 | 0.2ms | 1.7ms | 1.3ms | 1.3ms | 1.5x | 1.0x |
| 25 | 0.2ms | 2.1ms | 1.5ms | 1.4ms | 1.6x | 1.0x |
| 50 | 0.3ms | 2.4ms | 1.9ms | 1.7ms | 1.6x | 1.2x |
| 100 | 0.6ms | 4.1ms | 3.2ms | 3.4ms | 1.4x | 0.9x |
| 200 | 1.1ms | 11.2ms | 8.1ms | 7.9ms | 1.6x | 1.0x |
| 500 | 2.5ms | 61.4ms | 54.9ms | 54.4ms | 1.2x | 1.0x |
| 1000 | 9.8ms | 252.7ms | 223.7ms | 215.2ms | 1.2x | 1.0x |
| 2000 | 10.1ms | 919.8ms | 903.3ms | 905.0ms | 1.0x | 1.0x |
| 5000 | 26.2ms | 7,940.5ms | 7,780.1ms | 7,813.6ms | 1.0x | 1.0x |
...
| n | Build | Cold Solve | Warm Solve | SciPy | Cold Overhead | Warm Overhead |
|---|-------|------------|------------|-------|---------------|---------------|
| 10 | 0.1ms | 0.6ms | 0.3ms | 0.2ms | 4.3x | 2.1x |
| 25 | 0.1ms | 0.5ms | 0.4ms | 0.2ms | 4.1x | 2.7x |
| 50 | 0.2ms | 0.6ms | 0.5ms | 0.2ms | 4.9x | 2.9x |
| 100 | 0.3ms | 1.0ms | 0.7ms | 0.2ms | 7.4x | 3.9x |
| 200 | 0.5ms | 1.2ms | 1.2ms | 0.2ms | 9.1x | 6.4x |
| 500 | 1.2ms | 2.4ms | 1.9ms | 0.2ms | 15.8x | 8.5x |
| 1000 | 2.4ms | 4.2ms | 3.5ms | 0.3ms | 26.1x | 13.8x |
| 2000 | 4.6ms | 7.9ms | 15.7ms | 0.3ms | 39.7x | 49.9x |
| 5000 | 11.7ms | 19.0ms | 16.2ms | 0.4ms | 68.4x | 36.1x |
...
| n | Build | Cold Solve | Warm Solve | SciPy | Cold Overhead | Warm Overhead |
|---|-------|------------|------------|-------|---------------|---------------|
| 10 | 0.1ms | 0.9ms | 0.4ms | 0.3ms | 2.8x | 1.2x |
| 25 | 0.1ms | 1.0ms | 0.6ms | 0.5ms | 2.3x | 1.2x |
| 50 | 0.2ms | 1.1ms | 1.1ms | 0.6ms | 2.3x | 2.0x |
| 100 | 0.4ms | 1.5ms | 1.3ms | 0.9ms | 2.2x | 1.5x |
| 200 | 0.7ms | 2.6ms | 2.4ms | 1.7ms | 1.9x | 1.4x |
| 500 | 3.3ms | 10.5ms | 10.0ms | 8.9ms | 1.6x | 1.1x |
| 1000 | 10.2ms | 39.6ms | 39.8ms | 46.7ms | 1.1x | 0.9x |
| 2000 | 11.0ms | 205.4ms | 218.8ms | 214.8ms | 1.0x | 1.0x |
| 5000 | 32.9ms | 2,091.5ms | 2,095.0ms | 2,062.5ms | 1.0x | 1.0x |
...
| n | Build | Cold Solve | Warm Solve | SciPy | Cold Overhead | Warm Overhead |
|---|-------|------------|------------|-------|---------------|---------------|
| 10 | 0.1ms | 1.1ms | 1.0ms | 0.9ms | 1.3x | 1.2x |
| 25 | 0.1ms | 1.2ms | 1.1ms | 1.0ms | 1.3x | 1.1x |
| 50 | 0.2ms | 1.5ms | 1.3ms | 1.2ms | 1.4x | 1.1x |
| 100 | 0.4ms | 1.9ms | 1.8ms | 1.6ms | 1.4x | 1.1x |
| 200 | 1.4ms | 2.8ms | 3.1ms | 2.6ms | 1.6x | 1.2x |
| 500 | 65.7ms | 10.4ms | 8.8ms | 8.1ms | 9.4x | 1.1x |
| 1000 | 2.4ms | 27.5ms | 26.4ms | 25.6ms | 1.2x | 1.0x |
| 2000 | 4.7ms | 93.8ms | 90.1ms | 87.5ms | 1.1x | 1.0x |
| 5000 | 12.5ms | 544.2ms | 552.7ms | 539.2ms | 1.0x | 1.0x |
